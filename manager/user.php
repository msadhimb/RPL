      ...
      <div class="col-10">
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-2"></div>
            <div class="col-8">
              <h2 align="center">Data Order Users</h2>
              <div class="border border-2 rounded-3 p-3">
                <table class="table text-center">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    ...
                    $i2 = 1;
                    foreach ($data2 as $dddata => $list2) {
                      if ($list2['kode_pesanan'] == '') {
                      } else {
                    ?>
                        <tr>
                          ...
                          <?php if ($list2['bukti_transfer'] === '') { ?>
                            ...
                            <td><a class="btn btn-primary disabled" href="orderDone.php?idMngr=<?php echo $_GET['idMngr'] . "&kode_pesanan=" . base64_encode(sha1(rand()) . "|" . $list2['kode_pesanan']) ?>">Selesai</a></td>
                          <?php } else {
                          ?>
