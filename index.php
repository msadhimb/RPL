            ...
            <?php foreach ($data as $ddata => $list) { ?>
              <div class="col-4" align="center">
                ...
                <div class="card" style="width: 18rem; background-color: #f5f6fa">
                  <img src="assets/<?php echo $list['gambar'] ?>" class="card-img-top" alt="..." />
                  <div class="card-body">
              ...
              <div class="col-4" align="center">
                ...
                <div class="card" style="width: 18rem; background-color: #f5f6fa">
                  ...
                  <div class="card-body">
                    <h5 class="card-title"><?php echo $list['nama'] ?></h5>
                    <p class="card-text"><?php echo $list['deskripsi'] ?></p>
                    <a class="btn btn-primary" href="login.php"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                        <path fill-rule="evenodd" d="M8.22 2.97a.75.75 0 011.06 0l4.25 4.25a.75.75 0 010 1.06l-4.25 4.25a.75.75 0 01-1.06-1.06l2.97-2.97H3.75a.75.75 0 010-1.5h7.44L8.22 4.03a.75.75 0 010-1.06z"></path>
                      </svg>
                      Order</a>
                  </div>
